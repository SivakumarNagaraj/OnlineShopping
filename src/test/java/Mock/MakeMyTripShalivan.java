package Mock;
	...
	public class MakeMyTripShalivan {
		@Test
		public void main() throws Exception {
			...
			Workbook wb = WorkbookFactory.create(new FileInputStream("./src/test/resources/MakeMyTrip.xlsx"));
			...
			for (int i = 1; i <= flightName.size(); i++) {
				...
				wb.write(new FileOutputStream("./src/test/resources/MakeMyTrip.xlsx"));
			}
			wb.close();
			driver.close();
		}
